...
const skillCategories = [
  {
    icon: Code,
    title: "Technical",
    skills: ["Full Stack Development", "Web Development", "AI Enthusiast", "Product Development"],
  },
  {
    icon: TrendingUp,
    title: "Business",
    skills: ["Startup Strategy", "Business Analysis", "Growth & Scaling", "Networking"],
  },
  {
    icon: Palette,
    title: "Creative",
    skills: ["Graphic Design", "Branding", "Social Media Strategy"],
  },
  {
    icon: Users,
    title: "Leadership",
    skills: ["Team Management", "Event Management", "Mentoring", "Public Speaking"],
  },
];
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          {skillCategories.map((cat, i) => (
            <div
              key={i}
              className="bg-card border border-border rounded-xl p-6 card-hover shadow-[var(--shadow-card)]"
            >
