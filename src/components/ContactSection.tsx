    ...
    <section id="contact" className="py-24 gradient-navy">
      <div className="container mx-auto px-4 lg:px-8 text-center">
        ...
        <p className="text-primary-foreground/70 mb-10 max-w-md mx-auto">
          Whether it's a startup idea, collaboration, or just a conversation — I'm always open.
        </p>

        <div className="flex flex-wrap justify-center gap-4 mb-10">
          <a
            href="mailto:ceo@xplorevo.tech"
            className="inline-flex items-center gap-2 bg-primary-foreground/10 border border-primary-foreground/20 text-primary-foreground px-5 py-3 rounded-xl text-sm font-medium hover:bg-primary-foreground/15 transition-colors"
          >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 bg-green-500 text-primary-foreground px-8 py-3.5 rounded-xl text-base font-bold hover:bg-green-600 transition-colors"
        >
