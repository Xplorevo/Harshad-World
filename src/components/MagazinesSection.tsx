...
const magazines = [
  {
    ...
    image: xplorevoMag,
    link: "https://drive.google.com/file/d/1s4a_pYFXVv4u3o96MtgA03_k0G2-_mac/view",
  },
  {
    ...
    link: "https://drive.google.com/file/d/1C0GfcQbNOKT5oBUIgSBc_jjZpFW8eQXL/view",
  },
  {
    title: "E-Cell Advance",
    desc: "2026 Edition — Innovate Today, Elevate Tomorrow. The E-Cell Core journey.",
    image: ecellAdvanceMag,
    link: "https://drive.google.com/file/d/1oPhOtJcXgJ58YIODKRBBK6yH8AbCCkqI/view",
  },
];
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {magazines.map((mag) => (
            <div
              key={mag.title}
              className="bg-card border border-border rounded-2xl overflow-hidden card-hover shadow-[var(--shadow-card)] group"
            >
